...
1. create  a method named remove that accepts one int array and one int (index).
...
2. create  a method named remove that accepts one double array and one int (index).

3. create  a method named remove that accepts one String array and one int (index).

4. create  a method named remove that accepts one char array and one int (index).
