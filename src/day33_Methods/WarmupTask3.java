...
public class WarmupTask3 {
    ...
    public static void main(String[] args) {
        int [] array = {1,1,1,2,4,5,5,5,6}; // unique are 2,4,6
        ...
        int[] array2={100,200,300,200,400,500,200,300}; // [100, 400, 500]
        int[] r1=unique(array2);
        System.out.println(Arrays.toString(r1));

        double [] array3 = {2.5,3.5, 5.5,2.5, 3.5}; // [5.5]
        double[] r2 = unique(array3);
        System.out.println(Arrays.toString(r2));System.out.println(Arrays.toString(r1));
